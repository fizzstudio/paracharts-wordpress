		...
		if ( 'post' == $screen->base ) {
			...
			if ( 'post' == $screen->base ) {
				wp_enqueue_script(
					...
					array( 'paracharts-admin', 'chartjs', 'jquery', 'wpa11y' ),
					$version
				);
			}
			...
			wp_localize_script(
				...
				array(
					...
					'image_support'           => apply_filters( 'paracharts_image_support', 'no' ),
					'instant_preview_support' => apply_filters( 'paracharts_instant_preview_support', 'no' ),
